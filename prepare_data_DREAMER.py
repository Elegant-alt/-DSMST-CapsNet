...
class PrepareData:
    def __init__(self, args):
        ...
        self.original_order =  [ 'Fp1',  'Fp2',  'F3',  'F4',  'C3',  'C4',  'P3',  'P4',  'O1',  'O2',  'T3',  'T4',  'T5',  'T6'  
]  
        self.TS=[ 'Fp1',  'Fp2',  'F3',  'F4',  'C3',  'C4',  'P3',  'P4',  'O1',  'O2',  'T3',  'T4',  'T5',  'T6'  
]  
    ...
    def load_data_per_subject(self, sub):
        ...
        sub += 1
        if (sub < 10):
            sub_code = str('dreamer' + str(sub) + '.dat')
        else:
            sub_code = str('dreamer' + str(sub) + '.dat')
    ...
    def label_selection(self, label):
        ...
        if self.args.num_class == 2:
            label = np.where(label <= 3, 0, label)
